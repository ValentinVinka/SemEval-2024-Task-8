...
def test_model(train_df, model_path, output_path):
            
    # Pentru a încărca modelul din fișier
    with open(model_path, 'rb') as file:
        classifier = pickle.load(file)
    
    predicted = classifier.predict(test_df['text'])
    print(predicted)
    exit()
